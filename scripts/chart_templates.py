...
# ══════════════════════════════════════════════════════════════════════════
def bar_chart(data, x_col, y_col, title, xlabel, ylabel,
              color=BLUE, value_fmt='${:,.0f}', figsize=(10, 6),
              save_as=None):
    """
...
# ══════════════════════════════════════════════════════════════════════════
def line_chart(data, x_col, y_cols, title, xlabel, ylabel,
               colors=None, figsize=(12, 5), rotation=30,
               label_every=1, save_as=None):
    """
...
def scatter_plot(data, x_col, y_col, title, xlabel, ylabel,
                 color_col=None, color=BLUE, figsize=(9, 6), save_as=None):
    """
    ...
    p = np.poly1d(z)
    ax.plot(sorted(data[x_col]), p(sorted(data[x_col])),
            '--', color=RED, linewidth=1.5, alpha=0.7, label='Trend')
...
# ══════════════════════════════════════════════════════════════════════════
def histogram(data, col, title, xlabel, bins=30,
              color=BLUE, figsize=(10, 5), save_as=None):
    """
    bins: number of bars in the histogram — more bins = more detail
    """
    fig, ax = plt.subplots(figsize=figsize)

    ax.hist(data[col].dropna(), bins=bins,
...
# ══════════════════════════════════════════════════════════════════════════
def heatmap(data, title, fmt='.0f', cmap='Blues',
            figsize=(10, 7), save_as=None):
    """
...
# ══════════════════════════════════════════════════════════════════════════
def box_plot(data, x_col, y_col, title, xlabel, ylabel,
             color=BLUE, figsize=(10, 6), save_as=None):
    """
    ...
    order = (data.groupby(x_col)[y_col]
             .median()
